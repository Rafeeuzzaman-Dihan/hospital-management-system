<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="manage-patients.php" class="<?= basename($_SERVER['PHP_SELF']) == 'manage-patients.php' ? 'active' : '' ?>">Manage Patients</a></li>
        <li><a href="manage-lab.php" class="<?= basename($_SERVER['PHP_SELF']) == 'manage-lab.php' ? 'active' : '' ?>">Manage Lab Assistants</a></li>
